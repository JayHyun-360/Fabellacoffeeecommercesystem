    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
      ...
      <div className="relative bg-white w-full sm:max-w-sm sm:rounded-[2.5rem] rounded-t-[2rem] shadow-2xl overflow-hidden border border-gray-100 max-h-[95vh] flex flex-col">
        ...
        <div className="bg-gradient-to-br from-blue-600 to-blue-800 p-6 text-white relative flex-shrink-0">
          <button
            onClick={onClose}
            className="absolute top-5 right-5 w-8 h-8 flex items-center justify-center rounded-full bg-white/20 hover:bg-white/30 transition-all"
          >
            <X className="w-4 h-4" />
          </button>
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="tracking-widest text-xs font-bold uppercase text-blue-100">
              GCash Payment
            </span>
          </div>
        ...
        <div className="p-6 flex flex-col items-center gap-5 overflow-y-auto">
          ...
          <div className="w-full bg-blue-50/50 rounded-2xl p-4 text-center border border-blue-100/50">
            <p className="text-[10px] text-blue-500 font-bold uppercase tracking-wider mb-1">
              Fabella Coffee GCash
            </p>
            <p className="text-xl font-semibold tracking-wider text-blue-800">
              0917 123 4567
            </p>
          </div>
          ...
          <div className="flex items-start gap-3">
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between gap-2 flex-wrap mb-1.5">
                ...
                <span
                  className={`text-[10px] uppercase font-bold tracking-wider px-2.5 py-1 rounded-full flex items-center gap-1.5 border ${status.badge}`}
                >
              ...
              <div className="flex items-center gap-2 mt-1.5 flex-wrap">
                <span
                  className={`flex items-center gap-1 text-[11px] font-semibold px-2.5 py-0.5 rounded-full border ${orderType.bg} ${orderType.text} ${orderType.border}`}
                >
                  {orderType.icon}
                  {orderType.label}
                </span>
              ...
              <div className="flex items-center justify-between mt-3 pt-2.5 border-t border-gray-50">
                ...
                <div
                  className={`flex items-center gap-1 text-[11px] font-semibold px-2 py-0.5 rounded-full border border-gray-100 text-gray-600 bg-gray-50`}
                >
                  {payment.icon}
          ...
          <div className="border-t border-gray-100 bg-gray-50/50 p-5 space-y-4 animate-in slide-in-from-top-2 duration-300">
                ...
                {order.deliveryType === "delivery" && order.address ? (
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-sm text-gray-700 font-medium">
                      Pick Up at Store (Ramz Square Branch)
                    </span>
                  </div>
                )}
              </div>
            ...
            <div className="bg-white rounded-2xl p-4 space-y-2 border border-gray-100 shadow-sm">
              ...
              <div className="flex justify-between text-sm pt-2 border-t border-gray-100 font-bold text-gray-900">
                ...
                <span className="text-base text-black">₱{order.total}</span>
              </div>
